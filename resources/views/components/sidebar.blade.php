<aside id="sidebar" class="fixed top-11 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-6 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
